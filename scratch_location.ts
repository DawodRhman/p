...
// Correct Location Packet length is 0x1B (27)
const correctLocationData = Buffer.from([
...
console.log("Correct LOCATION calculated CRC:", calculateCRC16(correctLocationData).toString(16));
